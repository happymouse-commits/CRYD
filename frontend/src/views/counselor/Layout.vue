    ...
    <el-aside :width="isCollapse ? '64px' : '220px'" class="sidebar">
      <div class="logo-box" @click="isCollapse = !isCollapse">
        ...
        <transition name="fade">
          <span v-show="!isCollapse" class="logo-text">CRYD 辅导员端</span>
        </transition>
      </div>
      ...
      <el-menu
        ...
        class="side-menu"
      >
        <el-menu-item index="/counselor/profiles">
        ...
        <el-menu-item index="/counselor/leaves">
      ...
      <el-header class="topbar">
        <div class="topbar-left">
          ...
          <el-breadcrumb separator="/">
            <el-breadcrumb-item :to="{ path: '/counselor/profiles' }">首页</el-breadcrumb-item>
        ...
        <div class="topbar-right">
          ...
          <el-dropdown trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item disabled><el-icon><User /></el-icon> 辅导员</el-dropdown-item>
...
import { User, Warning, Document, Fold, FullScreen, ArrowDown, UserFilled, SwitchButton } from '@element-plus/icons-vue'
...
const pageTitle = computed(() => {
  const map = {
    '/counselor/profiles': '学生画像',
    '/counselor/warnings': '预警管理',
    '/counselor/leaves': '请假审批'
  }
  return map[route.path] || '辅导员工作台'
})
