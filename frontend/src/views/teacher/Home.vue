...
const actions = [
  { name: '知识库管理', path: '/teacher/knowledge-base', icon: Collection, color: '#409EFF' },
  { name: '布置作业', path: '/teacher/assignments', icon: Document, color: '#67C23A' },
  { name: '学情分析', path: '/teacher/analysis', icon: DataAnalysis, color: '#E6A23C' },
  { name: '个人信息', path: '/teacher/info', icon: User, color: '#909399' },
]
...
.s-val { font-size: 28px; font-weight: 700; color: #409EFF; }
.s-label { font-size: 13px; color: #909399; margin-top: 4px; }
</style>
